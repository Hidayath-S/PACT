...
public class NewHttpTarget extends NewBaseTarget{
	private String path;
    private  String host;
    private  int port;
  ...
  /**
     ...
     */
    public NewHttpTarget(final String host, final int port) {
        this("http", host, port);
    }
     ...
     * @param port port of tested service
     */
    public NewHttpTarget(final int port) {
     ...
     */
    public NewHttpTarget(final String protocol, final String host, final int port) {
     ...
     */
    public NewHttpTarget(final String protocol, final String host, final int port, final String path) {
     ...
     */
    public NewHttpTarget(final String protocol, final String host, final int port, final String path, final boolean insecure){
        super();
        this.host = host;
        this.port = port;
     ...
     */
    public NewHttpTarget(final URL url) {
        this(url, false);
    }
     ...
     * @param insecure true if certificates should be ignored
     */
    public NewHttpTarget(final URL url, final boolean insecure) {
