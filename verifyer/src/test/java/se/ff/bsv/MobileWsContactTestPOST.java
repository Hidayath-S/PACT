...
public class MobileWsContactTestPOST {
    ...
    public final Target target = new HttpTarget("http","localhost",8081,"/users"); // Out-of-the-box implementation of Target (for more information take a look at Test Target section)
